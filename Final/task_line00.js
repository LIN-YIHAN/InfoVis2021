d3.csv("https://LIN-YIHAN.github.io/InfoVis2021/Final/ageofsuicide.csv","https://LIN-YIHAN.github.io/InfoVis2021/Final/countryrate.csv")
.then( data => {
  data.forEach( d => { d.x = +d.x; d.y = +d.y;d.a = +d.a; d.b=+d.b });
...
class LineChart{
  ...
  init(){
    ...
    this.svg.append('text')
        ...
        .attr('x', '256')
        .attr('y', this.config.margin.top - title_space)
  ...
  update(){
    this.xscale
      ...
      .domain([0, d3.max(this.data, d => Number(d.age))])
